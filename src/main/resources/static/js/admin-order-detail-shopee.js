        ...
        success: function(response) {
            ...
            if (order) {
                ...
                if (order.status !== "IN_STOCK") {
                    $("#makeReadyShipBtn").prop("disabled", true);
                }
            ...
            if (shipment && shipment.shipperId) {
                ...
                $("#shipperName").text(shipment.shipperName || shipment.shipper?.fullname || "Không có tên");
                $("#shipperPhone").text(shipment.shipperPhone || shipment.shipper?.phone || "Chưa cập nhật");
                $("#shipperEmail").text(shipment.shipperEmail || shipment.shipper?.email || "Chưa cập nhật");
                $("#shipperAddress").text(shipment.shipperAddress || shipment.shipper?.address || "Chưa cập nhật");
