...
(3, 'Giày Bóng Đá', 'Giày chuyên dụng cho cầu thủ bóng đá, hỗ trợ bám sân và di chuyển nhanh'),
(4, 'Giày Bóng Rổ', 'Giày thể thao chuyên cho bóng rổ, hỗ trợ bật nhảy và bảo vệ cổ chân'),
...
INSERT INTO product (id, title, description, category_id, brand_id, price) VALUES
(1, 'Giày Thể Thao Nam Năng Động', 'Giày thể thao thiết kế hiện đại, phù hợp cho chạy bộ và tập gym', 1, 1, 1890000),
(2, 'Giày Thể Thao Running Pro', 'Giày chạy bộ chuyên nghiệp, đệm khí êm ái', 1, 2, 2350000),
(3, 'Giày Training All Day', 'Giày tập luyện đa năng, bám sân tốt', 1, 3, 1750000);

-- Giày Sneaker (Category 2)
INSERT INTO product (id, title, description, category_id, brand_id, price) VALUES
(4, 'Sneaker Street Style Đỏ', 'Sneaker phong cách đường phố, màu đỏ nổi bật', 2, 4, 1590000),
(5, 'Sneaker Low-Top Trắng', 'Sneaker trắng basic, dễ phối đồ', 2, 5, 1450000),
(6, 'Sneaker High-Top Canvas', 'Sneaker cổ cao vải canvas, style vintage', 2, 4, 1690000);

-- Giày Bóng Đá (Category 3)
INSERT INTO product (id, title, description, category_id, brand_id, price) VALUES
(7, 'Giày Bóng Đá Sân Cỏ TF', 'Giày bóng đá sân cỏ nhân tạo, đế TF bám sân cực tốt', 3, 1, 2890000),
(8, 'Giày Bóng Đá Mercurial', 'Giày bóng đá tốc độ, thiết kế khí động học', 3, 1, 3250000),
(9, 'Giày Đá Banh Predator', 'Giày sút bóng chuẩn xác, công nghệ Control Frame', 3, 2, 3150000);

-- Giày Bóng Rổ (Category 4)
INSERT INTO product (id, title, description, category_id, brand_id, price) VALUES
(10, 'Giày Bóng Rổ Air Jordan Style', 'Giày bóng rổ cổ cao, bảo vệ cổ chân tối ưu', 4, 1, 4590000),
(11, 'Basketball Shoes Pro', 'Giày bóng rổ chuyên nghiệp, đế cao su chống trơn', 4, 2, 4150000),
(12, 'Giày Bóng Rổ Harden Style', 'Thiết kế năng động, hỗ trợ bật nhảy', 4, 2, 3790000);

-- Sandals & Dép (Category 5)
INSERT INTO product (id, title, description, category_id, brand_id, price) VALUES
(13, 'Dép Quai Ngang Thời Trang', 'Dép quai ngang êm ái, phù hợp mùa hè', 5, 1, 590000),
(14, 'Dép Adilette Classic', 'Dép thể thao iconic, thoáng mát', 5, 2, 750000),
(15, 'Sandal Outdoor Adventure', 'Sandal dã ngoại, đi phượt, leo núi', 5, 9, 1150000);
